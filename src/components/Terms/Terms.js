  ...
  render () {
    ...
    return (
      <Modal size="lg" show={this.state.show}>
        <Modal.Header>
          <Modal.Title>Terms of Agreement</Modal.Title>
        </Modal.Header>
        <Modal.Body>End User License Agreement
License
Under this End User License Agreement (the &quot;Agreement&quot;), Writer&apos;s Alley, LLC (the &quot;Vendor&quot;) grants to the user (the &quot;Licensee&quot;) a non-exclusive and non-transferable license (the &quot;License&quot;) to use the interactive writing tutorial software (the &quot;Software&quot;).
...
Additional Clauses
This program is a teaching tool designed to help students learn about the writing process and important steps to writing better. Users will learn and improve based on the effort they put into the writing process. There are no guarantees for grades or quality of end product, which depend solely on the student. While each student has an individual account, there are no guarantees as to privacy of student information or written work.
Governing Law
...
Writer&apos;s Alley, LLC: 7283 Conservation St NE, Ada, MI 49301
        </Modal.Body>
        <Modal.Footer>
          <Button variant="dark" onClick={this.handleAccept}>
            Accept
          </Button>
        </Modal.Footer>
      </Modal>
